...
export default function TeamCard({ member, isOdd }) {
        ...
        <div className="team-card-new">
            <div className="team-header">
                ...
                <div className="team-photo-circle">
                    {/* We use a placeholder logic if image is missing, or member.image */}
                    {member.image ? (
            ...
            <div className="team-contact">
                <div className="team-contact" style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
